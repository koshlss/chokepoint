...
describe('будова «основна + допоміжна»', () => {
  ...
  /* Ріст сили з рівнем і «прокачка не вигідніша за нову вежу» тепер
     живуть у tests/power.test.ts і рахуються мірою сили — з площею,
     дальністю та ефектами. Тут були їхні спрощені копії на голій шкоді,
     і вони суперечили точним: дві версії одного правила гірше за одну. */
});
