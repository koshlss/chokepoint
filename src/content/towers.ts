...
const TOOLS: Tool[] = ([
  ...
  { key:'wall',    faction:'any',   tier:1, name:"Бар'єр",     cost:10,  dmg:0,   cd:0,  range:0,          shot:0,   swatch:'--t-wall',
    mazeOnly:true, blurb:'Не стріляє. Тільки подовжує шлях.' },

  /* ══ СТАЛЬ ══ основна ─────────────────────────────────────────────── */
  { key:'shard',   faction:'steel', tier:1, name:'Картеч',     cost:45,  dmg:15,   cd:18, range:tiles(2.3), shot:90,  swatch:'--t-shard',
    splash:tiles(0.6), blurb:'Дешева. Б’є площею, але зовсім поруч.' },
  { key:'arrow',   faction:'steel', tier:1, name:'Стріломет',  cost:90,  dmg:20,  cd:15, range:tiles(3.3), shot:110, swatch:'--t-arrow',
    blurb:'Швидка, по одній цілі, середня рука.' },
  { key:'mortar',  faction:'steel', tier:1, name:'Мортира',    cost:170, dmg:76,  cd:38, range:tiles(3.0), shot:70,  swatch:'--t-mortar',
    splash:tiles(1.1), blurb:'Рідко, зате важко й по площі.' },
  { key:'lance',   faction:'steel', tier:2, name:'Спис',       cost:260, dmg:114,  cd:32, range:tiles(4.2), shot:200, swatch:'--t-lance',
    blurb:'Дуже далеко й точно, по одній цілі.' },
  { key:'cannon',  faction:'steel', tier:2, name:'Гармата',    cost:380, dmg:143, cd:38, range:tiles(3.4), shot:90,  swatch:'--t-cannon',
    splash:tiles(1.35), blurb:'Важкий вибух по щільній групі.' },
  { key:'rail',    faction:'steel', tier:3, name:'Рейкотрон',  cost:620, dmg:359, cd:58, range:tiles(6.5), shot:260, swatch:'--t-rail',
    blurb:'Дістає через півкарти. Рідко й дуже боляче.' },

  /* ══ ВОГОНЬ ══ основна ────────────────────────────────────────────── */
  { key:'ember',   faction:'fire',  tier:1, name:'Іскра',      cost:45,  dmg:11,   cd:13, range:tiles(2.4), shot:105, swatch:'--t-ember',
    blurb:'Часто й дешево, але дістає ледь-ледь.' },
  { key:'flamer',  faction:'fire',  tier:1, name:'Вогнемет',   cost:90,  dmg:14,   cd:7,  range:tiles(2.0), shot:70,  swatch:'--t-flamer',
    dot:3, dotT:45, blurb:'Ллє безперервно й підпалює. Майже впритул.' },
  { key:'blaze',   faction:'fire',  tier:1, name:'Жаровня',    cost:170, dmg:67,  cd:34, range:tiles(2.7), shot:75,  swatch:'--t-blaze',
    splash:tiles(1.15), dot:3, dotT:60, blurb:'Вибух із підпалом по всьому поруч.' },
  { key:'forge',   faction:'fire',  tier:2, name:'Горнило',    cost:260, dmg:149,  cd:28, range:tiles(2.6), shot:85,  swatch:'--t-forge',
    dot:5, dotT:60, blurb:'Швидкий важкий вогонь на коротку руку.' },
  { key:'pyre',    faction:'fire',  tier:2, name:'Вогнище',    cost:380, dmg:156, cd:40, range:tiles(3.2), shot:120, swatch:'--t-pyre',
    splash:tiles(1.4), blurb:'Великий вибух. Тільки в тісняву.' },
  { key:'inferno', faction:'fire',  tier:3, name:'Пекло',      cost:620, dmg:251, cd:52, range:tiles(3.6), shot:130, swatch:'--t-inferno',
    splash:tiles(1.7), dot:9, dotT:80, blurb:'Найбільший вибух у грі, з довгим підпалом.' },
