...
const TOOLS: Tool[] = ([
  ...
  /* ══ ВОГОНЬ ══ основна ────────────────────────────────────────────── */
  { key:'ember',   faction:'fire',  tier:1, name:'Іскра',      cost:45,  dmg:9,   cd:13, range:tiles(2.4), shot:105, swatch:'--t-ember',
    blurb:'Дрібна, метушлива, дешева.' },
  { key:'flamer',  faction:'fire',  tier:1, name:'Вогнемет',   cost:90,  dmg:8,   cd:7,  range:tiles(2.0), shot:70,  swatch:'--t-flamer',
    dot:3, dotT:45, blurb:'Ллє без упину.' },
  { key:'blaze',   faction:'fire',  tier:1, name:'Жаровня',    cost:170, dmg:36,  cd:34, range:tiles(2.7), shot:75,  swatch:'--t-blaze',
    splash:tiles(1.15), dot:3, dotT:60, blurb:'Розжарена й непривітна.' },
  { key:'forge',   faction:'fire',  tier:2, name:'Горнило',    cost:260, dmg:62,  cd:28, range:tiles(2.6), shot:85,  swatch:'--t-forge',
    dot:5, dotT:60, blurb:'Гуде так, що чути здалеку.' },
  { key:'pyre',    faction:'fire',  tier:2, name:'Вогнище',    cost:380, dmg:115, cd:40, range:tiles(3.2), shot:120, swatch:'--t-pyre',
    splash:tiles(1.4), blurb:'Після неї лишається попіл.' },
  { key:'inferno', faction:'fire',  tier:3, name:'Пекло',      cost:620, dmg:260, cd:52, range:tiles(3.6), shot:130, swatch:'--t-inferno',
  ...
  { key:'glacier', faction:'ice',   tier:2, name:'Льодовик',   cost:320, dmg:60,  cd:40, range:tiles(3.2), shot:80,  swatch:'--t-glacier',
    splash:tiles(1.1), spread:tiles(1.9), slow:100, slowT:18, blurb:'Важка, повільна, невблаганна.' },
  { key:'rift',    faction:'ice',   tier:3, name:'Розлом',     cost:600, dmg:190, cd:46, range:tiles(3.8), shot:90,  swatch:'--t-rift',
    splash:tiles(1.4), spread:tiles(2.4), slow:100, slowT:26, blurb:'Повітря навколо неї тріскається.' },
