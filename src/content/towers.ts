...
const TOOLS: Tool[] = ([
  ...
  /* Дешевий ранній етап для «Облоги». Без такої вежі набір із самих
     дорогих (мортира 130, рейкотрон 200) не переживає перших хвиль на
     стартових 500 — бенчмарк валив його на 7-й. Від стрільомета
     відрізняється принципово: б'є площею, але майже впритул. */
  { key:'shard',  name:'Картеч',     cost:55,  dmg:10,  cd:20, range:tiles(2.4), shot:90,  swatch:'--t-shard',
