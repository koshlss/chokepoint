...
/* Партія починається на випадковій мапі. Восьма мапа нічого не дає, якщо
   гра щоразу відкривається на першій — саме так і виходило б: обирати
   мапу треба свідомо, а свідомо це роблять рідко.

   Кидок робиться РАЗ, при відкритті сторінки, і одразу перетворюється на
   звичайний вибір у списку. Тому «Новий забіг» перезапускає ту саму мапу
   (перегравати щойно програне — нормальне бажання), а сама симуляція
